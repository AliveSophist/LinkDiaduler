...
public class LinkDiaduler {
	...
	private void initialize() {
		...
		frameLinkDiaduler.setBounds((Toolkit.getDefaultToolkit().getScreenSize().width/2)-(Settings.LDWidth/2), (Toolkit.getDefaultToolkit().getScreenSize().height/2)-(Settings.LDHeight/2)+67, Settings.LDWidth, Settings.LDHeight);
		...
		pnlShowDate.setLayout(gbl_pnlShowDate);
			...
			gbc_lblSunDate.insets = new Insets(0, 0, 5, 0);
			...
			gbc_lblMonDate.insets = new Insets(0, 0, 5, 0);
			...
			gbc_lblTueDate.insets = new Insets(0, 0, 5, 0);
			...
			gbc_lblWedDate.insets = new Insets(0, 0, 5, 0);
			...
			gbc_lblThuDate.insets = new Insets(0, 0, 5, 0);
			...
			gbc_lblFriDate.insets = new Insets(0, 0, 5, 0);
			...
			gbc_lblSatDate.insets = new Insets(0, 0, 5, 0);
